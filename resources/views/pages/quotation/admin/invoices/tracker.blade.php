                                        ...
                                        <div class="text-right">
                                            @if($data['sale']->payment_status != 'Paid')
                                                <div class="d-inline-block" tabindex="0" data-toggle="tooltip" data-placement="bottom" title="Printing will be available upon full payment">
                                                    <a href="{{ route('invoices.print', $data['sale']->id) }}" class="btn btn-primary disabled">
                                                        <i class="fas fa-print"></i>  Print Invoice
                                                    </a>
                                                </div>
                                            @else
                                                <a href="{{ route('invoices.print', $data['sale']->id) }}" class="btn btn-primary">
                                                    <i class="fas fa-print"></i>  Print Invoice
                                                </a>
                                            @endif
                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#invoice_tracker_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('invoices.tracker.datatable', $data['sale']->id) }}',
                    data: (d) => {
